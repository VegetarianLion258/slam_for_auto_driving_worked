   ...
   public:
    ...
    void AddIMU(const IMU& imu) {
        ...
        if (dt > 0 && dt < 0.1) {
            ...
            if(0) {
                Eigen::Vector3d delta_ungravity_gyro = (imu.gyro_ - bg_) * dt;
                Eigen::AngleAxisd rollAngle(Eigen::AngleAxisd(delta_ungravity_gyro(0), Eigen::Vector3d::UnitX()));
                Eigen::AngleAxisd pitchAngle(Eigen::AngleAxisd(delta_ungravity_gyro(1), Eigen::Vector3d::UnitY()));
                Eigen::AngleAxisd yawAngle(Eigen::AngleAxisd(delta_ungravity_gyro(2), Eigen::Vector3d::UnitZ()));
